...
const api: ElectronAPI = {
  ...
  verifySecurityAnswers: (data: unknown) => safeInvoke(IPC_CHANNELS.AUTH_VERIFY_SECURITY_ANSWERS, data),
  ...
  createQuarter: (data: unknown) => safeInvoke(IPC_CHANNELS.QUARTERS_CREATE, data),
  updateQuarter: (data: unknown) => safeInvoke(IPC_CHANNELS.QUARTERS_UPDATE, data),
  ...
  createSubjectBank: (data: unknown) => safeInvoke(IPC_CHANNELS.SUBJECT_BANK_CREATE, data),
  ...
  getSubjectBankDeleteImpact: (id: string) => safeInvoke(IPC_CHANNELS.SUBJECT_BANK_DELETE_IMPACT, { id }),
