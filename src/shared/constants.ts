...
export const CONFLICT_CODES = {
  ...
  BLOCKED_BY_EVENT: { code: 'blocked_by_event', severity: 'SOFT' as ConflictSeverity },
...
export const CONFLICT_CODE_LABELS: Record<string, string> = {
  ...
  blocked_by_event: 'Some occurrences cancelled by a calendar event',
...
export const ERROR_CODES = {
  ...
  SEMESTER_PUBLISH_BLOCKED: 'SEMESTER_PUBLISH_BLOCKED',
  AY_PUBLISH_BLOCKED: 'AY_PUBLISH_BLOCKED',
