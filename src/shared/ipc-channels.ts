...
export const IPC_CHANNELS = {
  ...
  AUTH_GET_SECURITY_QUESTIONS: 'auth:get-security-questions',
  ...
  SEMESTERS_GENERATE_PREVIEW: 'semesters:generate-preview',
  SEMESTERS_GENERATE_EXECUTE: 'semesters:generate-execute',
